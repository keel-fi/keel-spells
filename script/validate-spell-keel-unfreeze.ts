...
const validations = [
  ["./scripts/controller-manage-controller/validate.ts", "./scripts/controller-manage-controller/configs/controller-active-mainnet.ts"],
];

/**
 * Runs:
 *
 *   forge test --json -vvvv --match-contract KeelEthereum_emergencyTest
